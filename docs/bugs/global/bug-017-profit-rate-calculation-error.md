...
**用户关注点**：
> "剩余资金: 12974.19 USDT之外是否还有未平仓金额？整个盈亏应该是按照账户的整体净值来计算，请确保没问题"
...
| 项目 | 金额（USDT） | 说明 |
|------|------------|------|
| 初始资金 | 10000.00 | --initial-cash参数 |
| 总盈亏 | +2974.19 | 所有已平仓订单的盈亏总和 |
| 剩余资金 | 12974.19 | 初始资金 + 总盈亏 |
| 未平仓订单 | 0 | 所有订单已平仓 |
| **账户净值** | **12974.19** | ✅ 计算正确 |
...
- ✅ 所有182个订单均已平仓（持仓中: 0）
- ✅ 没有未释放的资金在持仓订单中
- ✅ 账户净值 = 初始资金 + 总盈亏（10000 + 2974.19 = 12974.19）
- ✅ 整个盈亏确实按照账户的整体净值计算，计算逻辑正确
