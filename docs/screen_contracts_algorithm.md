...
```
Direction（方向） = |当前价 - 50根K线前的价格|
Volatility（波动） = Σ |每根K线的价格变化|（50根K线）
...
| KER | 趋势效率（越低越震荡）| < 0.4 | 50根4h K线（约8天） | 排除单边趋势 |
...
| KER | Kaufman Efficiency Ratio | 50根4h K线 | <0.4 | 趋势效率 |
