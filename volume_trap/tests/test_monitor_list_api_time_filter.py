...
class MonitorListAPITimeFilterTest(APITestCase):
    ...
    def test_time_filter_start_and_end_date(self):
        ...
        response = self.client.get(url, {"start_date": start_date_str, "end_date": end_date_str})
    ...
    def test_time_filter_with_status_filter(self):
        ...
        response = self.client.get(url, {"start_date": start_date_str, "status": "pending"})
    ...
    def test_time_filter_start_date_greater_than_end_date(self):
        ...
        response = self.client.get(url, {"start_date": "2025-12-26", "end_date": "2025-12-24"})
